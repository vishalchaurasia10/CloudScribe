...
const Login = (props) => {
    ...
    const loginUser = async (e) => {
        e.preventDefault();
        const response = await fetch(`https://cloud-scribe-backend.onrender.com/api/auth/login`, {
            method: 'POST',
            headers: {
        ...
        <>
            <div className="mainBlock bg-cover bg-center bg-no-repeat bg-[url('/src/assets/loginBackground.svg')] flex flex-col lg:flex-row justify-center items-center">
                ...
                <div className="container1 lg:order-2 space-y-0 flex flex-col justify-center items-center lg:h-screen lg:w-1/2">
                    <div className='text-lg lg:px-32 animate-scale text-[#392E33] p-4 tracking-wide pt-24 pb-8 lg:pb-1 text-center lg:pt-28 font-jost font-extrabold'>
