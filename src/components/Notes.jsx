...
const Notes = (props) => {
    ...
    return (
        <>
            ...
            <div className={`notesContainer transition-all duration-300 ${darkMode?'bg-[#212E35]':''} lg:px-32 bg-no-repeat bg-center bg-cover pt-28 bg-[url(/src/assets/addBackground.svg)] space-y-10`}>
